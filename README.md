...
`solar` runs the media stack — prowlarr, flaresolverr, sonarr, radarr, lidarr, beets, recyclarr, plex, tautulli, transmission — with media over NFSv4 from the NAS. All but beets, plex, recyclarr and tautulli are netns-confined to the wireguard container: the tunnel drops and their network drops with it.
