"""Container runtime and hardening posture.

Asserts against the uninstalled molecule instance -- the enumeration checks that
install the site live in test_web.py, which collects last.
"""
...
@pytest.mark.parametrize("name", CONTAINERS)
def test_container_healthcheck(host: Target, name: str) -> None:
    def ready() -> bool | None:
