...
- **No storage pools** — none is defined and none is needed: the tier
  addresses disks and the image cache by path. Pools appearing on a libvirt
  host are generated by `virt-install`.
